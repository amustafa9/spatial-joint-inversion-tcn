...
def train(**kwargs):
    ...
    for epoch in range(100):
        ...
        print("Epoch : {} | Marmousi Train Loss : {:0.4f}".format(epoch, loss1.item()))
        
     
    # load pretrained weights onto SEAM    
    model_seam.load_state_dict(model_marmousi.state_dict())
    ...
    for epoch in range(kwargs['epochs']):
      ...
      print('Epoch: {} | Seam Train Loss: {:0.4f} | Val Loss: {:0.4f}'\
            .format(epoch, loss2.item(), val_loss.item()))  
